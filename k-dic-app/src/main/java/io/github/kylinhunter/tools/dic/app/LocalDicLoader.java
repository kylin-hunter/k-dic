...
import io.github.kylinhunter.tools.dic.app.excel.DicDataReaders;
import io.github.kylinhunter.tools.dic.app.monitor.LocalDicFileMonitor;
...
public class LocalDicLoader extends AbstractDicLoader {
    ...
    public DictionaryMatcher get(DicType dicType) {
