...
import io.github.kylinhunter.tools.dic.core.dic.bean.DicDataPinyin;
...
import io.github.kylinhunter.tools.dic.words.pinyin.PinyinType;
...
public class DicDataReaderForPinyin extends AbstractExcelDicDataReader<DicDataPinyin> {
    private static PinyinService pinyinService = CF.get(PinyinType.BASIC.clazz);
